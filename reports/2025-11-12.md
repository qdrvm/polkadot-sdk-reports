...
* Fixed keys iteration logic
* Remaining steps
    * Workaround for merkle root calculation (if we will need historical blocks execution)
    * Cleanup PRs and request reviews
       * https://github.com/paritytech/polkadot-sdk/pull/10029/
       * https://github.com/paritytech/parity-common/pull/951
 ...
 * Historical queries are working!
